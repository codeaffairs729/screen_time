                ...
                <Dialog as="div" className="relative z-10" onClose={closeModal}>
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-0 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-[410px] transform overflow-hidden border-[2px] border-dtech-light-teal rounded-[10px] bg-white sm:p-14 p-6 text-left align-middle shadow-xl transition-all">
