    ...
    return (
        <div>
            ...
            <div
                ...
                onClick={generatePDF}
            >
                <div className="flex flex-row mr-6 bg-dtech-new-main-light hover:bg-[#FDD522] hover:text-black sm:hover:text-white sm:hover:bg-dtech-main-dark hover:border-b-2 border-black sm:hover:border-0 sm:p-4 sm:px-10 p-2 px-3 text-xs text-white font-semibold rounded-full">
