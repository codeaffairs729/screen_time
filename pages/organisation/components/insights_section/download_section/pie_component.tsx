...
const PieChartComponent = ({ chartData, isMobile }: { chartData: any, isMobile: any }) => {
    useEffect(() => {
    ...
    return <div id="chartdiv" style={{ width: isMobile?"100%":"70%", height: isMobile?"400px":"500px" }}></div>;
};
