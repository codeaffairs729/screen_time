...
const EmailSent = () => {
  ...
  return (
    <>
      ...
      <div className="grow flex flex-col items-center justify-center p-8 pt-0 text-center text-gray-600">
        An email containing a reset link to create a new password was sent to
        your email address if that email address exists in our records.
