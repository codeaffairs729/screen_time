    ...
    return (
        ...
        >
            <div
                ...
                className={clsx(
                    "cursor-pointer   flex items-center justify-between px-4 py-4 font-semibold text-[#727272]",
                    selected && "!bg-dtech-new-main-light !text-white "
                )}
            >
                ...
                <span className="select-none">
                    {selected ? (
                        stateIcon ? (
                            ...
                            <VscTriangleDown
                                className={`w-3 h-3 text-2xl text-inherit transition-all ${"rotate-180"} `}
                            />
                        )
                    ) : stateIcon ? (
                        { stateIcon }
